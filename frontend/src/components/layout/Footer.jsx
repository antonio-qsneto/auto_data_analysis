      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm">
            <li>Email: <a href="mailto:xclarity.ai@gmail.com" className="hover:text-cyan-400 transition">xclarity.ai@gmail.com</a></li>
            <li>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <span className="bg-indigo-700 text-xs px-2 py-1 rounded text-indigo-100">FastAPI/Django</span>
            <span className="bg-pink-700 text-xs px-2 py-1 rounded text-pink-100">ApexCharts</span>
            <span className="bg-yellow-700 text-xs px-2 py-1 rounded text-yellow-100">Python</span>
          </div>
        </div>
      </div>
    </footer>
